...
| E2E | `tests/ui_acceptance_real_llm_e2e.rs::e2e_2_real_llm_uses_phase_2_mcp_and_receives_a_screenshot` | `#[ignore]` | 真实 `@playwright/mcp` + 视觉 LLM，依赖 API key、npx 和浏览器，按需显式运行。 |
